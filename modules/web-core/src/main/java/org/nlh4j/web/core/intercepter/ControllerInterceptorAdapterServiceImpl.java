/*
 * @(#)ControllerInterceptorAdapterServiceImpl.java
...
/**
 * Service implementation for AspectJ point-cut controller
 */
@Slf4j
@Service("controllerInterceptorAdapterService")
public class ControllerInterceptorAdapterServiceImpl implements ControllerInterceptorAdapterService {
     ...
     */
    protected final boolean isRequestMapping(Class<?> targetClass, String method, Object[] medArgs) {
    ...
    /*
     * (non-Javadoc)
     * @see org.nlh4j.web.core.intercepter.ControllerInterceptorAdapterService#checkInvoke(java.lang.Class, java.lang.String, java.lang.Object[])
     */
    @Override
    public boolean checkInvoke(Class<?> targetClass, String method, Object[] medArgs) {
        // only intercept on RequestMapping methods
    ...
    /*
     * (non-Javadoc)
     * @see org.nlh4j.web.core.intercepter.ControllerInterceptorAdapterService#checkForward(java.lang.Class, java.lang.String, java.lang.Object[])
     */
    @Override
    public String checkForward(Class<?> targetClass, String method, Object[] medArgs) {
    	// only intercept on RequestMapping methods
    ...
    /*
     * (non-Javadoc)
     * @see org.nlh4j.web.core.intercepter.ControllerInterceptorAdapterService#afterInvoke(java.lang.Class, java.lang.String, java.lang.Object[], java.lang.Object)
     */
    @SuppressWarnings("unchecked")
	@Override
    public void afterInvoke(Class<?> targetClass, String method, Object[] medArgs, Object value) {
        ...
        if (BeanUtils.isInstanceOf(value, ModelAndView.class)) {
            ...
            log.debug("Class: [" + targetClass.getName()
                    + "] - Method: [" + method
     ...
     */
    protected final boolean hasRootPermission(Class<?> targetClass, String method) {
     ...
     * @return true for allowing; otherwise false
     */
    protected final boolean hasUserPermission(String userName, Class<?> targetClass, String method) {
        // parse info to check
        ...
        else log.debug(">>> Not require permission on [" + targetClass.getName() + "] controller");
        ...
        if (!allowed) {
            ...
            else log.debug(">>> Not require permission on method [" + method + "] of [" + targetClass.getName() + "] controller");
