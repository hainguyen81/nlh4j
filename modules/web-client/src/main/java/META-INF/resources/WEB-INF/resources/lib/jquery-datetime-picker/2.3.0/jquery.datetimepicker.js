				...
				input
					.on('open.xdsoft focusin.xdsoft mousedown.xdsoft',function initOnActionCallback(event) {
						if( input.is(':disabled')||input.is(':hidden')||!input.is(':visible')||input.data( 'xdsoft_datetimepicker')
								||(!options.allowOnReadonly && input.is('[readonly]'))
								||(options.disableOnClass && options.disableOnClass.length > 0 && input.hasClass(options.disableOnClass)) )
							return;
 ...
 * details.
 */
// Move code to jquery.datetime.utils.js
