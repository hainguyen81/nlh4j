importModuleController(
		...
		function($scope, ajaxService, $rootScope, $log) {
			...
			$scope.onSave = function(e) {
				...
				var module = angular.fromJson(angular.toJson($.extend($scope.model.group, { companies: data })));
				ajaxService.post({
		        		url: '/system/role/assign/save',
		        		data: module,
		        		success: function(data) {
