      ...
      return function(scope, element, attrs, ctrls, transcludeFn) {
        ...
        function onDocumentClick(e) {
          ...
          if (!contains && !$select.clickTriggeredSelect) {
            ...
            if (!skipFocusser) {
            	skipFocusser = (e.target && e.target.tagName
            			&& ~focusableControls.indexOf(e.target.tagName.toLowerCase())); //Check if target is input, button or textarea
            }
        ...
        // TODO just mouse-down/scroll/wheel (for scrolling case)
        //$document.on('mousedown', onDocumentClick);
        //$document.on('scroll', onDocumentClick);
        //$document.on('wheel', onDocumentClick);

        scope.$on('$destroy', function() {
          $document.off('click', onDocumentClick);
          // TODO just mouse-down/scroll/wheel (for scrolling case)
          //$document.off('mousedown', onDocumentClick);
          //$document.off('scroll', onDocumentClick);
          //$document.off('wheel', onDocumentClick);
        });
    ...
    link: function(scope, element, attrs, ctrls) {
      ...
      scope.$on('uis:close', function (event, skipFocusser) {
        $timeout(function(){
          ...
          // @TODO change skipFocuser to true to restrict windows scroll to TOP while selecting
          skipFocusser = true;
