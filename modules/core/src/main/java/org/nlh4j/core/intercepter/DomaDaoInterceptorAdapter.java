...
@Aspect
@Component
public class DomaDaoInterceptorAdapter extends AbstractHandlerInterceptorAdapter {
	 ...
	 */
	@Around("org.nlh4j.core.intercepter.AspectSystemArchitecture.inDomaDaoLayer()")
//	@Around("execution(public * org.seasar.doma.internal.jdbc.dao.AbstractDao+.*(..))")
	public Object inDaoLayer(ProceedingJoinPoint joinPoint) throws Throwable {
