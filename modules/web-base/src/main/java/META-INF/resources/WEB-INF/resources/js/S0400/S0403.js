importModuleController(
		...
		function($scope, ajaxService, $rootScope) {
			...
			$scope.onSave = function(e) {
				...
				var module = angular.fromJson(angular.toJson($.extend($scope.model.module, { companies: data })));
				ajaxService.post({
		        		url: '/system/module/assign/save',
		        		data: module,
		        		success: function(data) {
