...
<spring:message var="m_codename" code="${pageModule}.detail.module" />
<spring:message var="m_codename_prompt" code="${pageModule}.detail.module.prompt" />
