/*
 * @(#)HttpUtils.java 1.0 Sep 28, 2016
...
public final class HttpUtils implements Serializable {
    ...
    public static final class RequestHeadersFactory
        ...
        /*
         * (Non-Javadoc)
         * @see org.springframework.http.client.HttpComponentsClientHttpRequestFactory#postProcessHttpRequest(org.apache.hc.core5.http.ClassicHttpRequest)
         */
        @Override
     ...
     * @param <E> the request body entity typ
     * @param url to send
